# Getting help with mlboot

Thanks for using mlboot. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/mlboot/issues) to make sure the 
